...
// Get company's places
$places_sql = "SELECT 
    p.*,
    COUNT(pb.booking_id) as total_bookings,
    COUNT(CASE WHEN pb.booking_status = 'confirmed' THEN 1 END) as confirmed_bookings,
                    ...
                    <div class="place-card">
                        ...
                        <div class="place-content">
                            ...
                            <div class="place-stats">
                                ...
                                <div class="stat">
                                    <div class="stat-value"><?php echo $place['confirmed_bookings']; ?></div>
                                    <div class="stat-label">Confirmed</div>
                                </div>
                                <div class="stat">
                                    <div class="stat-value"><?php echo $place['total_reviews']; ?></div>
