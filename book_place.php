...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $booking_stmt->bind_param("iisssssdssss", $place_id, $company_id, $booking_type, $start_date, $end_date, $start_time, $end_time, $total_cost, $contact_person, $contact_email, $contact_phone, $special_requirements, $booking_notes);
